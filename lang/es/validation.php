...
/*
|--------------------------------------------------------------------------
| Mensajes de validación en español (Laravel)
|--------------------------------------------------------------------------
|
| Sin este archivo, Laravel devuelve la CLAVE cruda de la regla (p.ej.
| "validation.after") en lugar de un mensaje legible. El app es API-only y
| 100% en español (APP_LOCALE=es), por eso el único idioma publicado es es.
|
*/
...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña dada aparece en una fuga de datos. Por favor elige otra.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensaje de validación personalizado (recurso)
    |--------------------------------------------------------------------------
    |
    | Puedes especificar mensajes personalizados para los atributos usando la
    | convención "atributo.regla". Ej.:
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos personalizados (reemplazan el nombre del campo)
    |--------------------------------------------------------------------------
    |
    | Traducen el nombre técnico del campo a un rótulo legible dentro de los
    | mensajes ("La fecha de fin debe ser posterior a la fecha de inicio.").
    |
    */
    ...
    'attributes' => [
        ...
        'nivel_id' => 'nivel',
        'grado_id' => 'grado',
        'ano_lectivo_id' => 'año lectivo',
        'direccion' => 'dirección',
        'telefono' => 'teléfono',
        'responsable' => 'responsable',
        'es_principal' => 'sede principal',
